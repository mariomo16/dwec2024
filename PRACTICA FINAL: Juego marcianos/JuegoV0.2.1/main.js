/*
    ...
    - Hacer que el misil se mueva hacia arriba, y se elimine al tocar la parte de arriba de la pantalla
    - Hacer que cada enemigo tenga coordenadas distintas
...
document.addEventListener("keydown", (e) => {
    ...
    if (
        ...
        // Si en algún momento no se ajusta al borde, cambiar naveJugador.offsetWidth por naveJugador.offsetWidth/2
        ...
        coordenadaX = naveJugador.offsetLeft;
        // Si en algún momento no se ajusta al borde, cambiar 0 por naveJugador.offsetWidth/2
