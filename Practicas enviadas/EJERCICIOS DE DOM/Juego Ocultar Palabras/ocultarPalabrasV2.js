/*
  ...
  Descripción:
  Aplicación web (juego) para intentar adivinar palabras ocultas de una cadena de texto (el usuario indica cuantas palabras se ocultaran).
  * Distingue entre mayúsculas y minúsculas

  En algún momento cambie cosas del código y quizás se me olvido cambiar/quitar algún comentario que ya no es necesario
*/
