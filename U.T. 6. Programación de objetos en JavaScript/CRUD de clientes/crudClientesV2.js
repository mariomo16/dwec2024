...
function CrearCliente() {
    ...
    let cliente = {
        ...
        edad: edad,
        fechaNacimiento: new Date(fechaNacimiento).toLocaleString(
            "es-ES",
            fecha
        ),
    };
...
function modificarCliente() {
    ...
    if (clientes[idBusqueda] !== undefined) {
        /*
            ...
            <form>
                ...
                <br/>
                    ...
                    <input 
                        type="button" 
                        value="Guardar datos" 
                        onclick="guardarDatos(document.getElementById('newNombre').value, 
                                document.getElementById('newEdad').value, 
                                document.getElementById('newFechaNacimiento').value, 
                                '${idBusqueda}')" />
                </fieldset>
            </form>
    `;
...
function borrarCliente() {
    ...
    // En el caso ed que exista un 'cliente' con ese ID (indice)
    if (clientes[idBusqueda] != undefined) {
        // Saco ese objeto de clientes[] y lo meto en la variable creada anteriormente para poder mostrar su nombre
